      ...
      <AnimatePresence>
        {!showInitialLoader && !isUnlocked && (
          ...
          >
            ...
            <div className="relative w-full max-w-md luxe-card p-8 md:p-10 text-center overflow-hidden border-2 border-pink-300/40">
              ...
              <div className="relative z-10 flex flex-col items-center">
                    ...
                    return (
                      <motion.div
                        ...
                        animate={{
                          ...
                          borderColor: isFilled ? '#ff4d8d' : 'rgba(255, 255, 255, 0.3)',
                          backgroundColor: isFilled ? 'rgba(255, 77, 141, 0.3)' : 'rgba(255, 255, 255, 0.1)',
                        }}
                ...
                {error ? (
                  <motion.div
                    ...
                    className="mb-6 px-4 py-2 rounded-xl bg-rose-950/80 border border-rose-500/50 text-rose-200 text-xs md:text-sm font-medium flex items-center gap-2 justify-center"
                  >
                ...
                <div className="grid grid-cols-3 gap-3.5 w-full max-w-xs">
                  {['1', '2', '3', '4', '5', '6', '7', '8', '9'].map((num) => (
                    <motion.button
                      ...
                      className="h-14 rounded-2xl luxe-glass text-xl font-bold text-white flex items-center justify-center transition-all duration-200 border border-white/30 hover:border-pink-300/60 shadow-md"
                    >
                      {num}
                    </motion.button>
                  ))}
                  ...
                  <motion.button
                    ...
                    className="h-14 col-start-2 rounded-2xl luxe-glass text-xl font-bold text-white flex items-center justify-center transition-all duration-200 border border-white/30 hover:border-pink-300/60 shadow-md"
                  >
                    0
                  </motion.button>

                  <motion.button
                    whileHover={{ scale: 1.06, backgroundColor: 'rgba(244, 63, 94, 0.4)' }}
                    whileTap={{ scale: 0.94 }}
                    onClick={handleDelete}
                    className="h-14 col-start-3 rounded-2xl luxe-glass text-lg font-bold text-rose-300 flex items-center justify-center transition-all duration-200 border border-rose-400/40 shadow-md"
                  >
                ...
                {/* Decorative Footer */}
                <div className="mt-8 pt-4 border-t border-white/10 w-full flex items-center justify-between text-xs text-pink-200/70">
